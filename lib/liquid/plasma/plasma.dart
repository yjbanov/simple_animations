...
enum ParticleType {
  ...
  ///
  /// This method is computationally more expensive than [vertex] but it
  /// produces perfectly shaped circles at all blur levels.
  circle,

  /// Renders all particles from a prerasterized atlas scaled to the particle size.
  ///
  /// This method is best under the following circumstances:
  ///
  /// * Blur is high enough to hide atlas pixelation.
  /// * Blur value does not change during animation.
  ///
